...
def train_model_s(s,data):
    ...
    moment = s[3]
    nesterov = s[4]
    return train_model(activation, n_couches, noeuds, lr, moment, nesterov, data)

def train_model(activation, n_couches, noeuds, lr, moment, nesterov , data):
    ...
    opt = keras.optimizers.SGD(lr=lr, momentum=moment, decay=0.0, nesterov=nesterov)
